...
```{r lorenz_curve, dpi=100, fig.retina=2, fig.height=2.5, fig.width=4, warning=FALSE}
...
```{r matrix_plot_df, dpi=100, fig.retina=2,  fig.height=5, fig.width=8.25}
...
```{r matrix_plot, dpi=200, fig.retina=2,  fig.height=5, fig.width=8.25, warning=FALSE, message=FALSE}
...
```{r correlation_plots, dpi = 200, fig.retina = 2,  fig.height = 2, fig.width=3, warning=FALSE}
df_cor <- data.frame()
...
```{r correlations, dpi = 200, fig.retina=2,  fig.height=2, fig.width=3.5, warning=FALSE}
...
```{r jci_jif_05, dpi = 200, fig.retina=2,  fig.height=2, fig.width=3.5, warning=FALSE, message=FALSE}
...
```{r jci_jif, dpi = 200, fig.retina=2,  fig.height=2, fig.width=3.5, warning=FALSE, message=FALSE}
ggplot(data=jci_jif, aes(y=Correlation, x=DB, group=DB))+
  geom_boxplot(outlier.shape=NA, width=0.8) +
  geom_jitter(data=jci_jif[which(jci_jif$Indicator=='Journal Impact Factor'),], aes(fill=Correlation, size=Docs), shape=21, color='black', stroke=0.5, alpha=0.6)+
  scale_fill_gradient(low='white', high='#eb2701', na.value=NA, breaks=c(0.5, 0.75, 1), limits=c(0.5,1))+
...
```{r other_correlations, dpi=200, fig.retina=2,  fig.height=3.5, fig.width=4.5, message=FALSE}
